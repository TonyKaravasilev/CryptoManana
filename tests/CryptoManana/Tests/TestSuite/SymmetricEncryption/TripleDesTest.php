...
/**
 * Testing the 3DES-168 realization used for data encryption/decryption.
 */
...
/**
 * Class TripleDesTest - Testing the 3DES-168 class.
 *
 * @package CryptoManana\Tests\TestSuite\SymmetricEncryption
 */
final class TripleDesTest extends AbstractUnitTest
{
    /**
     * Creates new instances for testing.
     *
     * @return TripleDes Testing instance.
    ...
    public function testBasicDataEncryptionAndDataDecryption()
    {
        ...
        $this->assertTrue($crypter instanceof TripleDes);
