...
/**
 * Testing the DSA-2048 realization used for data signing/verification.
 */
...
/**
 * Class Dsa2048Test - Testing the DSA-2048 class.
 *
 * @package CryptoManana\Tests\TestSuite\Hashing
 */
final class Dsa2048Test extends AbstractUnitTest
{
    /**
     * The filename for the private key temporary file.
     */
    const PRIVATE_KEY_FILENAME_FOR_TESTS = 'dsa_2048_private.key';

    /**
     * The filename for the public key temporary file.
     */
    const PUBLIC_KEY_FILENAME_FOR_TESTS = 'dsa_2048_public.key';
     ...
     *
     * @return Dsa2048 Testing instance.
    ...
    public function testBasicDataSigningAndSignatureVerification()
    {
        ...
        $this->assertTrue($signature instanceof Dsa2048);
