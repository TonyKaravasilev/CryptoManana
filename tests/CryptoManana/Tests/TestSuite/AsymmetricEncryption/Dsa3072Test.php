...
final class Dsa3072Test extends AbstractUnitTest
{
     ...
     */
    const PRIVATE_KEY_FILENAME_FOR_TESTS = 'dsa_3072_private.key';

    /**
     * The filename for the public key temporary file.
     */
    const PUBLIC_KEY_FILENAME_FOR_TESTS = 'dsa_3072_public.key';
     ...
     *
     * @return Dsa3072 Testing instance.
    ...
    public function testBasicDataSigningAndSignatureVerification()
    {
        ...
        $this->assertTrue($signature instanceof Dsa3072);
