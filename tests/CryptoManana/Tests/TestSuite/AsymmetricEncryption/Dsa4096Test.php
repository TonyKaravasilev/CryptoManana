...
/**
 * Testing the DSA-4096 realization used for data signing/verification.
 */
 ...
 */
final class Dsa4096Test extends AbstractUnitTest
{
    /**
     * The filename for the private key temporary file.
     */
    const PRIVATE_KEY_FILENAME_FOR_TESTS = 'dsa_4096_private.key';

    /**
     * The filename for the public key temporary file.
     */
    const PUBLIC_KEY_FILENAME_FOR_TESTS = 'dsa_4096_public.key';
     ...
     *
     * @return Dsa4096 Testing instance.
    ...
    public function testBasicDataSigningAndSignatureVerification()
    {
        ...
        $this->assertTrue($signature instanceof Dsa4096);
