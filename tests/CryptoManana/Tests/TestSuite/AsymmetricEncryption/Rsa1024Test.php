...
/**
 * Testing the RSA-1024 realization used for data encryption/decryption.
 */
...
/**
 * Class Rsa1024Test - Testing the RSA-1024 class.
 *
 * @package CryptoManana\Tests\TestSuite\AsymmetricEncryption
 */
final class Rsa1024Test extends AbstractUnitTest
{
    /**
     ...
     *
     * @return Rsa1024 Testing instance.
    ...
    public function testBasicDataEncryptionAndDataDecryption()
    {
        ...
        $this->assertTrue($crypter instanceof Rsa1024);
