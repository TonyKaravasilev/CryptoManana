...
/**
 * Testing the RSA-4096 realization used for data encryption/decryption.
 */
...
/**
 * Class Rsa4096Test - Testing the RSA-4096 class.
 *
 * @package CryptoManana\Tests\TestSuite\Hashing
 */
final class Rsa4096Test extends AbstractUnitTest
{
    /**
     * The filename for the private key temporary file.
     */
    const PRIVATE_KEY_FILENAME_FOR_TESTS = 'rsa_4096_private.key';

    /**
     * The filename for the public key temporary file.
     */
    const PUBLIC_KEY_FILENAME_FOR_TESTS = 'rsa_4096_public.key';
     ...
     *
     * @return Rsa4096 Testing instance.
    ...
    public function testBasicDataEncryptionAndDataDecryption()
    {
        ...
        $this->assertTrue($crypter instanceof Rsa4096);
