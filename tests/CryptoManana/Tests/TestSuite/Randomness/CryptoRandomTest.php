...
/**
 * Testing the secure pseudo-randomness realization used for cryptography secure sequence generation.
 */
 ...
 */
final class CryptoRandomTest extends AbstractUnitTest
{
    /**
     * How many times to rerun generation tests.
     */
    const REPEATED_TESTS_COUNT = 20;

    /**
     * Creates new instances for testing.
     *
     * @return CryptoRandom Testing instance.
     */
    ...
    public function testSeedingAndAutoSeedingActions()
    {
        ...
        $this->assertNull(CryptoRandom::setSeed(null));

        /**
         * Cryptographic pseudo-randomness must not allow controllable results.
         *
         * {@internal No seeding is available for this type of object. }}
         */
    ...
    public function testSupportedRangeForIntegerGeneration()
    {
        ...
        $this->assertEquals(PHP_INT_MAX, $randomness->getMaxNumber());
        $this->assertEquals(PHP_INT_MIN, $randomness->getMinNumber());
