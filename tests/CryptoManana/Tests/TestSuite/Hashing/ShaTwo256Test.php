...
/**
 * Testing the SHA-2 family SHA-256 realization used for digest generation.
 */
...
final class ShaTwo256Test extends AbstractUnitTest
{
    ...
    public function testTheOutputDigestIsNeverEmpty()
    {
        ...
        $this->assertTrue($hasher instanceof ShaTwo256);
    ...
    public function testUnicodeStringHashing()
    {
        ...
        $this->assertEquals(
            'cc7a9d31491c5a608a0df280211d03afa4a76532964993400702918e60b0c610',
    ...
    public function testSaltingCapabilitiesForHashingActions()
    {
        ...
        $this->assertEquals(
            '90E2CD6AFAF9CDEF6EB243188C6D09247658DFC06FEB2CA784C67A4220BBD4E4',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            '0A996E1D53BA90E91D915F897A78FCB7D719A40E693C2E692DD7F64BAFE7014E',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            '6891215062C56F3376EC1BBAA1D4C5741879E8B3EEB12CC8FC683CEF08B0C6A0',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            'F31B65BC6D0ADD3809C6B9E506B796A6CD6585769389266C9BC5A79A566AF43E',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            'ED1762947AFCF02D0A938914A7D147DFC26F8BAFB964CBCF54FBB3CBB04D3E2D',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            '44BB20B662687CA6E13125E2923C6DEA8FC18E6C868EF6139067F736DA340DF9',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            'B9AC75A153A8DC85A52BCF955A1CEBA8AB5D35C8E8A3F8EEBE5E2463EFA2E8F3',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            'B2630764069D0E2AEDDFC07A74C38AC4270781DEF851F067F0ED99C0C4A1E5DE',
            $hasher->hashData($data)
        );
    }
