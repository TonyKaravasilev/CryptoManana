...
/**
 * Testing the SHA-2 family PBKDF2-SHA-224 realization used for digest generation.
 */
...
/**
 * Class Pbkdf2ShaTwo224Test - Testing the SHA-2 family PBKDF2-SHA-224 class.
 *
 * @package CryptoManana\Tests\TestSuite\Hashing
 */
final class Pbkdf2ShaTwo224Test extends AbstractUnitTest
{
    /**
    ...
    public function testTheOutputDigestIsNeverEmpty()
    {
        ...
        $this->assertTrue($hasher instanceof Pbkdf2ShaTwo224);
    ...
    public function testUnicodeStringHashing()
    {
        ...
        foreach ($testCases as $toUse) {
            ...
            $this->assertEquals(
                '98955889ba5de932c97cc8b6ff0f2def1fd1335e20fa8531a4a423c8',
    ...
    public function testDigestOutputFormatsForHashingData()
    {
        ...
        $this->assertEquals(
            hex2bin('107246fb539a69ada433332275865a3e8ca1156277308393c800a057'),
            $hasher->hashData('')
        );
        ...
        $this->assertEquals(
            '107246FB539A69ADA433332275865A3E8CA1156277308393C800A057',
            $hasher->hashData('')
        );
        ...
        $this->assertEquals(
            'EHJG+1Oaaa2kMzMidYZaPoyhFWJ3MIOTyACgVw==',
            $hasher->hashData('')
        );
    ...
    public function testSaltingCapabilitiesForHashingData()
    {
        ...
        $this->assertEquals(
            '83A64B0E9D5D10674A440677DD02E2D96A1554899CDD9F0D3181654A',
        ...
        $this->assertEquals(
            '9FCE7F57A62DB96E9EBB8CFC77480ACF0A3728E2DD41B5F3068F309D',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            '1A2E26A7B87872F046A934FE885BEA5B774E6A3F88E424D40FFFCA7D',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            '09D8BB8707D51317397A39BCB164309E11939BFF4ADCED5CB0536B68',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            '79C3E69AA1127B9C18D833BFFE5EDE48D4AE7A379018950F7BFB5DD0',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            '0984609AAB473B4FA9F3580057ADAF22F70924ADD05D719E9F728ED8',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            'A661126B152DBD11235566375C88EEB99135F4AE83EB9903159B0133',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            '168DA49DD574120636B2352E9D255D42B55D402EDBED2B060F9D9CBC',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            '5C0415FA7F33046B553B3545887EFFA27F06BDD8E875AA3B424D6F38',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            '645110F5EAA92259C0278206FA3A099BFB2BC06BEFE94CB398A41F93',
            $hasher->hashData($data)
        );
    }
