...
/**
 * Testing the PBKDF2-MD5 realization used for digest generation.
 */
...
/**
 * Class Pbkdf2Md5Test - Testing the PBKDF2-MD5 class.
 *
 * @package CryptoManana\Tests\TestSuite\Hashing
 */
final class Pbkdf2Md5Test extends AbstractUnitTest
{
    /**
    ...
    public function testTheOutputDigestIsNeverEmpty()
    {
        ...
        $this->assertTrue($hasher instanceof Pbkdf2Md5);
    ...
    public function testUnicodeStringHashing()
    {
        ...
        foreach ($testCases as $toUse) {
            ...
            $this->assertEquals(
                'ef26c577bd9c483c39436e5b3f905343',
    ...
    public function testDigestOutputFormatsForHashingData()
    {
        ...
        $this->assertEquals(
            hex2bin('9c627ef8f3723c914c7bf25e2344a8ed'),
            $hasher->hashData('')
        );
        ...
        $this->assertEquals(
            '9C627EF8F3723C914C7BF25E2344A8ED',
            $hasher->hashData('')
        );
    ...
    public function testSaltingCapabilitiesForHashingData()
    {
        ...
        $this->assertEquals(
            '3BB8EB8AA4C50D67D4A6EB432D1E0C12',
        ...
        $this->assertEquals(
            '82B497CA5DFC4C0729CA86A77930AC20',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            'B2C5138AD3424BDBDD08D241FA529CE2',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            '6AA16B456009FEAF71CAF308D0978189',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            '8BCFA23CB1980EFA9B2310DAA9478F2D',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            'C0927B07B0269AA75CBD84B8CEDF480B',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            'CB922EB20D4B57392697E9BCF7617F9A',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            'CF9CEC3710A21533A081FE453496A2EE',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            '3FD940194492C88CE42B7077B2F08281',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            '91CF24F07161F5B8E9B42038FA00F5D5',
            $hasher->hashData($data)
        );
    }
