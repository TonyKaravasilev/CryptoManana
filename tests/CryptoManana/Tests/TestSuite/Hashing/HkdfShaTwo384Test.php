...
/**
 * Testing the SHA-2 family HKDF-SHA-384 realization used for digest generation.
 */
...
/**
 * Class HkdfShaTwo384Test - Testing the SHA-2 family HKDF-SHA-384 class.
 *
 * @package CryptoManana\Tests\TestSuite\Hashing
 */
final class HkdfShaTwo384Test extends AbstractUnitTest
{
    /**
    ...
    public function testTheOutputDigestIsNeverEmpty()
    {
        ...
        $this->assertTrue($hasher instanceof HkdfShaTwo384);
    ...
    public function testUnicodeStringHashing()
    {
        ...
        foreach ($testCases as $toUse) {
            ...
            $this->assertEquals(
                '0bae73347a1393e1251c3e50b44387df45b0233a32c9805a4d37d7c1d4c75' .
                '034419fee0727012808c74bf00841b41ebd',
    ...
    public function testDigestOutputFormatsForHashingData()
    {
        ...
        $this->assertEquals(
            hex2bin(
                'f8a602e59c8870e9a9f94a6e6a680bb4643ab268dd8d563c8a74934dd0f143e35' .
                'c3ab65bdfa131ae4dd2e27c52f74de7'
            ),
            $hasher->hashData('')
        );
        ...
        $this->assertEquals(
            'F8A602E59C8870E9A9F94A6E6A680BB4643AB268DD8D563C8A74934DD0F143E3' .
            '5C3AB65BDFA131AE4DD2E27C52F74DE7',
            $hasher->hashData('')
        );
        ...
        $this->assertEquals(
            'f8a602e59c8870e9a9f94a6e6a680bb4643ab268dd8d563c8a74934dd0f143e35c' .
            '3ab65bdfa131ae4dd2e27c52f74de7',
            $hasher->hashData('')
        );
        ...
        $this->assertEquals(
            '+KYC5ZyIcOmp+UpuamgLtGQ6smjdjVY8inSTTdDxQ+NcOrZb36Exrk3S4nxS903n',
            $hasher->hashData('')
        );
    ...
    public function testSaltingCapabilitiesForHashingData()
    {
        ...
        $this->assertEquals(
            '4D0303DCD0CA32B59B6E16D5E416119D47A15C065CDCAEFC971CAC5B7B246CBDA94EA972B293CED7383C19880F6FD36B',
        ...
        $this->assertEquals(
            'C3DD2655EC3600E8C5D87DB21E8BC5E089013BC3D7ECA80B3703622C2787FC043C35A45916D3E85BA293D68A71F14549',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            'D074AEE7160C677ED6DE0062AC9746AC8683CB695404AD8545F790058808852E4B7A3F40597C66BC88F772824843E62C',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            'EED2ECAD9356C38A91623D0A15FD0DAF0F1AA3EA41A74C10757B8091BAC52BCD180B6C5B5D36FF70AD73DE94513F96FE',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            '2580B28724A1D2C9793D9123510B3321C71E47484624DA036A29060619A1B14621BE96C73C21C66FB353967176EA41E8',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            '7215C804C652A17208471794EE51617B0DC626E1BCA46ABB679768632A3A7403220E3E7470D5AAAB0046516CE8BE14A9',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            '23FE3F5016F1A2FF8489E56E1F5BE2A60328FE5AF524EAECE2C7BC0B46652A0F2D2E5D013AF6ED0859C2DDDEEAE19EFF',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            '4DAE8F02EB7F03B8E18610071C3ADB48459916F56472B15916543303862D60579CC45065078AA3053BE858F1489BC699',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            '4A3AAAF9664FB210E00B75BA753B1A10BEB8141F32A2D47D75C0C0EC63FA81752B7C9252F54685ACC26C80B6A6F2B355',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            '6160BDF56346E1DDA71BC204D5F1EF4872B53F972EFD21B52014D5704138D2B0AB09E6AE2C5017F026B5A3ACDE3A9190',
            $hasher->hashData($data)
        );
    }
