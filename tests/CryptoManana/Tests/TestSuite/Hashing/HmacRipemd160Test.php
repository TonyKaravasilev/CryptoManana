...
/**
 * Testing the HMAC-RIPEMD-160 realization used for digest generation.
 */
...
/**
 * Class HmacRipemd160Test - Testing the HMAC-RIPEMD-160 class.
 *
 * @package CryptoManana\Tests\TestSuite\Hashing
 */
final class HmacRipemd160Test extends AbstractUnitTest
{
    /**
     * Creates new instances for testing.
     *
     * @return HmacRipemd160 Testing instance.
    ...
    public function testTheOutputDigestIsNeverEmpty()
    {
        ...
        $this->assertTrue($hasher instanceof HmacRipemd160);
    ...
    public function testUnicodeStringHashing()
    {
        ...
        foreach ($testCases as $toUse) {
            ...
            $this->assertEquals(
                '91cefc2988b5dae50506458858698028b6ea5663',
    ...
    public function testDigestOutputFormatsForHashingData()
    {
        ...
        $this->assertEquals(
            hex2bin('7eee56e47fb639a2628da45d74cbd2b66a998c98'),
            $hasher->hashData('')
        );
        ...
        $this->assertEquals(
            '7EEE56E47FB639A2628DA45D74CBD2B66A998C98',
            $hasher->hashData('')
        );
    ...
    public function testSaltingCapabilitiesForHashingData()
    {
        ...
        $this->assertEquals(
            'CF42F5A9C4A5664BB060739134E488C2E9560552',
        ...
        $this->assertEquals(
            '1192CE12E6638174891ECC8B741E13B3C107D1E0',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            '299EECD0627B1B88B0390457EC7DDD74EAA6B5D3',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            'D4274FDE4E00BC7442727CE950359077B09DEFF9',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            '55DBB8A370321368DF8991AC02DA195A62137DD3',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            '38B28C9D7CFB40B06A8BAC515AB406C7298509B1',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            '7BC402AB81831B1CB9C58BA4D8DAF33CC8B23D8A',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            'B2DC2D28F314973BC06075CC189DE89387151F8E',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            '72652B07BAB5F9E11285481A3CC7D30CB8FFFB85',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            '31C079F721E86A3C74D78E1B83DB01BB2C67F8DC',
            $hasher->hashData($data)
        );
    }
