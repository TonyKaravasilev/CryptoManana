...
/**
 * Testing the HKDF-SHA-1 realization used for digest generation.
 */
...
/**
 * Class HkdfSha1Test - Testing the HKDF-SHA-1 class.
 *
 * @package CryptoManana\Tests\TestSuite\Hashing
 */
final class HkdfSha1Test extends AbstractUnitTest
{
    /**
     ...
     *
     * @return HkdfSha1 Testing instance.
    ...
    public function testTheOutputDigestIsNeverEmpty()
    {
        ...
        $this->assertTrue($hasher instanceof HkdfSha1);
    ...
    public function testUnicodeStringHashing()
    {
        ...
        foreach ($testCases as $toUse) {
            ...
            $this->assertEquals(
                '6aac29fe24e2821f320badddde4e085c7ec6de06',
    ...
    public function testDigestOutputFormatsForHashingData()
    {
        ...
        $this->assertEquals(
            hex2bin('46e262fef3d69516a54b6b3f34b27fa5c952ff66'),
            $hasher->hashData('')
        );
        ...
        $this->assertEquals(
            '46E262FEF3D69516A54B6B3F34B27FA5C952FF66',
            $hasher->hashData('')
        );
    ...
    public function testSaltingCapabilitiesForHashingData()
    {
        ...
        $this->assertEquals(
            'A2A13644AB1C22BB1C6DFC4E98D2A74E1D9F15F0',
        ...
        $this->assertEquals(
            'B3C158BA3CD28D7F5D4C2D2FD8BBF62E4EE11B1F',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            '20493DC95CE0C6A169E99D6FD3D4A77F814552E0',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            '3AAECADEA2DC521B24B8BAB0852B5C7196995AE7',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            '9700385D93CCA3D1FECFED26EE8DC0FB1CE0DED8',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            '66A33956720AF45C73EB6F1EB44B9303A08F7DA4',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            '37AC777708AFAB9DA8A86E3A34AA4B30CC0F1915',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            'E9507D9D564A44B3BD3B78057194A8F63D920986',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            '2D70C4F84C8FB35D9988DCD6C8F0EF687E3BE32C',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            '1FCC283CC51CF3A4121B89C9A273D707BE090577',
            $hasher->hashData($data)
        );
    }
