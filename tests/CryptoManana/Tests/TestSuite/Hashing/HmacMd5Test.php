...
/**
 * Testing the HMAC-MD5 realization used for digest generation.
 */
...
/**
 * Class HmacMd5Test - Testing the HMAC-MD5 class.
 *
 * @package CryptoManana\Tests\TestSuite\Hashing
 */
final class HmacMd5Test extends AbstractUnitTest
{
    /**
     * Creates new instances for testing.
     *
     * @return HmacMd5 Testing instance.
    ...
    public function testTheOutputDigestIsNeverEmpty()
    {
        ...
        $this->assertTrue($hasher instanceof HmacMd5);
    ...
    public function testDigestOutputFormatsForHashingData()
    {
        ...
        $this->assertEquals(
            hex2bin('6aebb41d4366c2794687e1d9e7aee307'),
            $hasher->hashData('')
        );
        ...
        $this->assertEquals(
            '6AEBB41D4366C2794687E1D9E7AEE307',
            $hasher->hashData('')
        );
    ...
    public function testSaltingCapabilitiesForHashingData()
    {
        ...
        $this->assertEquals(
            '7FC71E92CDC354AA7726966B47F4164E',
        ...
        $this->assertEquals(
            '9E86F851E1F9276DB851F174501D4259',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            'D534FECEFBA8A2AC8B08D95A52FE0B3C',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            '47CB71C9C51215F7C0AA7AC0902C3C4A',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            'CFE6163173627A2CEAFBEA4A69E5EE41',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            '4938723951D26FF13723DDF867F9E981',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            'A27116B19C4855A7E601A778B18150D1',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            'D02AD7E3FDF5F98704B7123283653D8A',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            '97BA69BB2D93A8130C7B19F04B7AFAC3',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            '756208F61B09511914DC77B484B07DD4',
            $hasher->hashData($data)
        );
    }
