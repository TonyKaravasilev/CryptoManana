...
/**
 * Testing the PBKDF2-RIPEMD-128 realization used for digest generation.
 */
...
/**
 * Class Pbkdf2Ripemd128Test - Testing the PBKDF2-RIPEMD-128 class.
 *
 * @package CryptoManana\Tests\TestSuite\Hashing
 */
final class Pbkdf2Ripemd128Test extends AbstractUnitTest
{
    /**
    ...
    public function testTheOutputDigestIsNeverEmpty()
    {
        ...
        $this->assertTrue($hasher instanceof Pbkdf2Ripemd128);
    ...
    public function testUnicodeStringHashing()
    {
        ...
        foreach ($testCases as $toUse) {
            ...
            $this->assertEquals(
                '26f198f26c6fe09081d7fb8d6e54b000',
    ...
    public function testDigestOutputFormatsForHashingData()
    {
        ...
        $this->assertEquals(
            hex2bin('383f44e6cf0a301c8b0fa529b0406b9c'),
            $hasher->hashData('')
        );
        ...
        $this->assertEquals(
            '383F44E6CF0A301C8B0FA529B0406B9C',
            $hasher->hashData('')
        );
    ...
    public function testSaltingCapabilitiesForHashingData()
    {
        ...
        $this->assertEquals(
            'D44D8F2B0DE93E5D127B2F1ADD83C0D7',
        ...
        $this->assertEquals(
            '93EE3EF011239B5AFE907D06ACCAA532',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            '7F9D3C34539A0C7E82A1FA01D5A5030C',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            '5089833CE34D6BF31A4CDA71370D85E3',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            '72297BD5F2C039B6B5D86C760A3F775C',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            '95C392D33B74126B415EA853948A8813',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            '2A9A1941ECC9DF8E87B150280303224F',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            '2ED350AC093F57BF3F43F6D4683292E5',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            'A1B1A55EE61323EB7AADA9726415300C',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            'A63218104DD9FF71831A162950AF1623',
            $hasher->hashData($data)
        );
    }
