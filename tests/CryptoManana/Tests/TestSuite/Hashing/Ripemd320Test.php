...
/**
 * Testing the RIPEMD-320 realization used for digest generation.
 */
...
/**
 * Class Ripemd320Test - Testing the RIPEMD-320 class.
 *
 * @package CryptoManana\Tests\TestSuite\Hashing
 */
final class Ripemd320Test extends AbstractUnitTest
{
    /**
     * Creates new instances for testing.
     *
     * @return Ripemd320 Testing instance.
    ...
    public function testTheOutputDigestIsNeverEmpty()
    {
        ...
        $this->assertTrue($hasher instanceof Ripemd320);
    ...
    public function testUnicodeStringHashing()
    {
        ...
        foreach ($testCases as $toUse) {
            ...
            $this->assertEquals(
                'f26e9e35a9a792fea0cb5b616008805a5329136cec65cb5f5e1eb59fd008475d226af2dc624798ff',
    ...
    public function testDigestOutputFormatsForHashingData()
    {
        ...
        $this->assertEquals(
            hex2bin('22d65d5661536cdc75c1fdf5c6de7b41b9f27325ebc61e8557177d705a0ec880151c3a32a00899b8'),
            $hasher->hashData('')
        );
        ...
        $this->assertEquals(
            'ItZdVmFTbNx1wf31xt57QbnycyXrxh6FVxd9cFoOyIAVHDoyoAiZuA==',
            $hasher->hashData('')
        );
    ...
    public function testSaltingCapabilitiesForHashingData()
    {
        ...
        $this->assertEquals(
            '3B0A2E841E589CF583634A5DD265D2B5D497C4CC44B241E34E0F62D03E98C1B9DC72970B9BC20EB5',
        ...
        $this->assertEquals(
            'B9D8CAA43FD6416F64C7281C8392B1C691C3925B15B8CBCF4A4E906A21970E9B33333B8D56B63F32',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            '1E4983BD625D9DD42401D45A08139DA62ACA7A39D91FABE22E8F29F7FEE07FF3B6BE499E0611DAB9',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            '51EF65867DAE4433F00AA78331725C2B8FFA904A2C28CA4E1F3BBCE5DCB45AF47BE98119CC694C9D',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            'F9DCCF689EB3512D1722BAD280AB1C4B7295D9211AB662BEC82D99425073E2E1C98232B07EF1C55F',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            '099991FFCEE7415B10A17FACA430BD1E39E477C1FBDB7D7E1DA035B3DE56582FF81C3459740AC391',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            'E5CC66E345B89D55952996E5A26C29C2BFE0AA7F23AE8E76D3BEB5F71330BA29B78DDFD906E1BAFA',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            '252439B7768D5F2B20F5B180CFE1ED76EB6C9A0A1E88245CB6501571579FD960AA0FF8F8B67E0630',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            '062F84847608FC2480F178AB430125B0368D0CFE1159A6A535B346D1A4B123C0EB796888FC2ED009',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            'F0B32266B0CA6DE421DD56FC9FF5916B277C1E9D3AD1F7F05C6A0E8245BBB675E6D85E1E478C7EC4',
            $hasher->hashData($data)
        );
    }
