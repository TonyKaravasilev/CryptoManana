...
/**
 * Testing the SHA-3 family HKDF-SHA-224 realization used for digest generation.
 */
...
/**
 * Class HkdfShaThree224Test - Testing the SHA-3 family HKDF-SHA-224 class.
 *
 * @package CryptoManana\Tests\TestSuite\Hashing
 */
final class HkdfShaThree224Test extends AbstractUnitTest
{
    /**
    ...
    public function testTheOutputDigestIsNeverEmpty()
    {
        ...
        $this->assertTrue($hasher instanceof HkdfShaThree224);
    ...
    public function testUnicodeStringHashing()
    {
        ...
        foreach ($testCases as $toUse) {
            ...
            $this->assertEquals(
                'b684be9e175e37aa89416c2147d72597abf8f1e043cabaa9998389ae',
    ...
    public function testDigestOutputFormatsForHashingData()
    {
        ...
        $this->assertEquals(
            hex2bin('b9413caabc49e82c22c554d0be64ee99d445ff8a87a8e1609a3d768b'),
            $hasher->hashData('')
        );
        ...
        $this->assertEquals(
            'B9413CAABC49E82C22C554D0BE64EE99D445FF8A87A8E1609A3D768B',
            $hasher->hashData('')
        );
        ...
        $this->assertEquals(
            'uUE8qrxJ6CwixVTQvmTumdRF/4qHqOFgmj12iw==',
            $hasher->hashData('')
        );
        ...
        $this->assertEquals(
            'uUE8qrxJ6CwixVTQvmTumdRF_4qHqOFgmj12iw',
            $hasher->hashData('')
        );
    }
    ...
    public function testSaltingCapabilitiesForHashingData()
    {
        ...
        $this->assertEquals(
            'E617C2020D9C7EE353C1664D1A35BA0460DC4FEE5993BD48D6077336',
        ...
        $this->assertEquals(
            'D2C710D14DE70C7C29EB6DC8BD250F862E43365CD1E31718CE715466',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            '10D450087DB97A054771ACC68172D1087085E28835153C8BD0977080',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            '09D8C477581E6B9A84EB6898C70590DD5BB4FD53C77DE96938A485BC',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            '77DD7304209F357220FAA491AFA11240A8448E72B56582BF3CC9D263',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            'E9A86D8AB9316594E17D3B421EEC89EAA0F76E22E053198259914801',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            '9A2312D6DE62D563716D143CD515448431D021D363F4997DDDBD81A9',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            'D7216D577E0291BD2ACDCCBBC10805CDDCE20338AB9B88B3BF8431FD',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            '22780B48E58BC1DE3D6F9BFADF92AEA101E4D998F7130582B5479A51',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            'C2FBA9CFDB4E4D6F504B4C071FF19F8DD6EA6152A5A2722B04DD609E',
            $hasher->hashData($data)
        );
    }
