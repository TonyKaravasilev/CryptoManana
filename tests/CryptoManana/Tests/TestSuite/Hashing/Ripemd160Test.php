...
/**
 * Testing the RIPEMD-160 realization used for digest generation.
 */
...
/**
 * Class Ripemd160Test - Testing the RIPEMD-160 class.
 *
 * @package CryptoManana\Tests\TestSuite\Hashing
 */
final class Ripemd160Test extends AbstractUnitTest
{
    /**
     * Creates new instances for testing.
     *
     * @return Ripemd160 Testing instance.
    ...
    public function testTheOutputDigestIsNeverEmpty()
    {
        ...
        $this->assertTrue($hasher instanceof Ripemd160);
    ...
    public function testUnicodeStringHashing()
    {
        ...
        foreach ($testCases as $toUse) {
            ...
            $this->assertEquals(
                '5f8566f6412ed689742080ac141c952d444df77a',
    ...
    public function testDigestOutputFormatsForHashingData()
    {
        ...
        $this->assertEquals(
            hex2bin('9c1185a5c5e9fc54612808977ee8f548b2258d31'),
            $hasher->hashData('')
        );
    ...
    public function testSaltingCapabilitiesForHashingData()
    {
        ...
        $this->assertEquals(
            'CBB6CC0642B45702935B87ACC392403FA539787B',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            'E96B01707E9005849F071A3FC1BF72E6D014DDE3',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            '71DDAFBF32BF4F85F4F5DF2B237DC826389F0DF9',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            '47DEF95050904FF525089926FF5337F98A6535AD',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            '5B9B5A1E3581F1256C17EC2ED36E7D732D5B72B9',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            'EC247EE0CA70A6C126D43E03A314FA9976E42283',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            'DCE135761A4EB5A269A5FF240F8E3A9529EEFFCA',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            '340DFE7E0B8C6CCF1F7E0E48D0BFD67979132692',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            'EF84AD9281C013A7D319795B9013D4442AFFF449',
            $hasher->hashData($data)
        );
    }
