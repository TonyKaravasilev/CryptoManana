...
/**
 * Testing the SHA-3 family HKDF-SHA-256 realization used for digest generation.
 */
 ...
 */
final class HkdfShaThree256Test extends AbstractUnitTest
{
    /**
    ...
    public function testTheOutputDigestIsNeverEmpty()
    {
        ...
        $this->assertTrue($hasher instanceof HkdfShaThree256);
    ...
    public function testUnicodeStringHashing()
    {
        ...
        foreach ($testCases as $toUse) {
            ...
            $this->assertEquals(
                '17343140ee57e557c68507fd02a91acd9092c17195a085dee9c7f619426cabbe',
    ...
    public function testDigestOutputFormatsForHashingData()
    {
        ...
        $this->assertEquals(
            hex2bin('261a068aa94d4e6e0ef2f4043cc3d967f5c21ca645d4d8239dc1d81b3f75444f'),
            $hasher->hashData('')
        );
        ...
        $this->assertEquals(
            '261A068AA94D4E6E0EF2F4043CC3D967F5C21CA645D4D8239DC1D81B3F75444F',
            $hasher->hashData('')
        );
        ...
        $this->assertEquals(
            'JhoGiqlNTm4O8vQEPMPZZ/XCHKZF1NgjncHYGz91RE8=',
            $hasher->hashData('')
        );
        ...
        $this->assertEquals(
            'JhoGiqlNTm4O8vQEPMPZZ_XCHKZF1NgjncHYGz91RE8',
            $hasher->hashData('')
        );
    }
    ...
    public function testSaltingCapabilitiesForHashingData()
    {
        ...
        $this->assertEquals(
            '4071F5FB4AF45D2673C3B545A4E0761FF7B762A3662529454865025D5D98BB41',
        ...
        $this->assertEquals(
            'DABD31A697054BE2D916D972E6ABAD19D6A3FEE65CE5826392C1EA381571A587',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            '0D7C78E96662DD4F17A2FE4B3B2D6AD7793DE391C227F5B684B9345BD0526A54',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            '2C6A44BFB4D6B964D53E9AFA8C5520EA5EAA7037568ACFFED9310544A973289E',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            '87D27D180546DE0126A0565538583AD46EF5F543E1454934D444F0DBC6F77F20',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            'AEEC0621897723991A22E5AF921166438EBAE3151EB95749E390704AEA7C4F7A',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            'C4119926A9CAAB971E19C58B06AFB1FFE577320FCF23A8C538432F6518E9F746',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            '40543D62FF43656A3733637D047895B9E682A6A80EF2DE56ACE09D1E573A2B9A',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            '29240E9491BD50152439788626D7B8F3CDBA24C18C6A60ECD7E43D3195D2292A',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            '0AB018A38592C7D1D0875ECCCD06EC88D0472A580FDC4EBEB502E7FC605A56D8',
            $hasher->hashData($data)
        );
    }
