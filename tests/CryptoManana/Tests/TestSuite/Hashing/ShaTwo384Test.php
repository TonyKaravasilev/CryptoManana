...
/**
 * Testing the SHA-2 family SHA-384 realization used for digest generation.
 */
...
/**
 * Class ShaTwo384Test - Testing the SHA-2 family SHA-384 class.
 *
 * @package CryptoManana\Tests\TestSuite\Hashing
 */
final class ShaTwo384Test extends AbstractUnitTest
{
    /**
     * Creates new instances for testing.
     *
     * @return ShaTwo384 Testing instance.
     * @throws \Exception If system does not support algorithm.
     */
    private function getHashAlgorithmInstanceForTesting()
    {
        return new ShaTwo384();
    }
    ...
    public function testTheOutputDigestIsNeverEmpty()
    {
        ...
        $this->assertTrue($hasher instanceof ShaTwo384);
    ...
    public function testDigestGenerationAndOutputFormatsActions()
    {
        ...
        $this->assertEquals(
            '38B060A751AC96384CD9327EB1B1E36A21FDB71114' .
            'BE07434C0CC7BF63F6E1DA274EDEBFE76F65FBD51AD2F14898B95B',
            $hasher->hashData('')
        );
    ...
    public function testSaltingCapabilitiesForHashingActions()
    {
        ...
        $this->assertEquals(
            '25421D7C7E6FD6AA71F707353CC3408FA1FB316E698136553B0E03EEA875A7808670E168300482228307A09504D7FDD4',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            'D95A71A80D77829A20808A625E042F9A3E9E6BB16A88CD1AF5355D54CAC026B49BFAA25C148024885DD34A9B5FA8986D',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            '2E591ACE14856EB3F0E91C791295B723DE50522A084D3CD2C06C3FD45D375D1B4B8E98B55D703374BFC7FAA58DA8F706',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            '5409D96BF10D346996AAC6A0095933341ADAA73E1CEAF02EBB9E79F917713DD80F414BD13E63E7ADE049FEB8BAFE5B0A',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            '0CF76938AE9136E30B0ABB27BB166E260F29726D7902420A136334924082AD9D826EB73855723EB99B12ABE26427F1A3',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            '22540DB76D1879E8081C5252B733C850FCA1A8071E5D7EAFA1CD761FAEE1A2E72639AA015F71F5C10EDCCA08B212097C',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            'A3584E0BEF18EC3898BB05CAAE3CC60C7DC12AB56FE64366C0969ABE5FF4226814DFBC3AFA1BA028FE47DE09851C132E',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            '37D983E17ACD3B078073FD52614FADFABFD9AFC95E9E48BD2B7641619B910E2E2CAE91898FDAC7DA0244BAED6D0A61B6',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            '4F5DC5C5F97531E823A4F56021E7BB9ACD3173748FDF495CF5F2405052F440C60C7B9344606B24223D81794D4F0BE425',
            $hasher->hashData($data)
        );
    }
