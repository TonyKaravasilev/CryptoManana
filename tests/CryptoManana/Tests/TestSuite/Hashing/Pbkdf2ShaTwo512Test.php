...
/**
 * Testing the SHA-2 family PBKDF2-SHA-512 realization used for digest generation.
 */
...
/**
 * Class Pbkdf2ShaTwo512Test - Testing the SHA-2 family PBKDF2-SHA-512 class.
 *
 * @package CryptoManana\Tests\TestSuite\Hashing
 */
final class Pbkdf2ShaTwo512Test extends AbstractUnitTest
{
    /**
    ...
    public function testTheOutputDigestIsNeverEmpty()
    {
        ...
        $this->assertTrue($hasher instanceof Pbkdf2ShaTwo512);
    ...
    public function testUnicodeStringHashing()
    {
        ...
        foreach ($testCases as $toUse) {
            ...
            $this->assertEquals(
                '2b5963eae28e1feabaeb9fb7f99a7b86dcae22525495e5913c6f8dd5426946bafff' .
                'a769539e750b65f36337d0cb13be4bcebdf70c8fc3adee536cca0b3bb94a4',
    ...
    public function testDigestOutputFormatsForHashingData()
    {
        ...
        $this->assertEquals(
            hex2bin(
                '6d2ecbbbfb2e6dcd7056faf9af6aa06eae594391db983279a6bf27e0eb2286143ab0' .
                'c996f33ca4b667e945829ea693340f2831797324e5f31df18ed171d18c97'
            ),
            $hasher->hashData('')
        );
        ...
        $this->assertEquals(
            'bS7Lu/subc1wVvr5r2qgbq5ZQ5HbmDJ5pr8n4OsihhQ6sMmW8zyktmfpRYKeppM0DygxeXMk5fMd8Y7RcdGMlw==',
            $hasher->hashData('')
        );
        ...
        $this->assertEquals(
            'bS7Lu_subc1wVvr5r2qgbq5ZQ5HbmDJ5pr8n4OsihhQ6sMmW8zyktmfpRYKeppM0DygxeXMk5fMd8Y7RcdGMlw',
            $hasher->hashData('')
        );
    }
    ...
    public function testSaltingCapabilitiesForHashingData()
    {
        ...
        $this->assertEquals(
            'D55B7D62DCADB29625FF82172CF2C4E237B5CC0A3D4531E5D842F0D0F1D6B' .
            '225ACA2A8BE3E89005FC4D1E5D094C5BAC83CD06E5CCB3F23BB3580EFE4CAC28911',
        ...
        $this->assertEquals(
            '0B487D59D18510C97F197FE809D13B03E54BB00554D5F6CF633434A401912' .
            '0D5E6E2476242961D82F846E2D1ACFEAF37DFC7F18197D79AD8CD10D3D34CC8BCB3',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            '15BF57195CE412C3DA3863049CACE8ACE569A6CFB4E7493264E2717C017' .
            '988C8BD5A7B8D5790426AA1750AA4E099581573253D8670C073C330B50DDCC33BBC8A',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            '937CF879309611ED1E365520D938F030ECE05A9454600EB8DA81FE1A93E9A' .
            '24B78B8F2A1B2B20AC9597FF61D8B75B355E553C017458280A2F3BB57F6F91ACBD2',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            '78F016E527B471E9A316BFC5BB615765192EB2EE713DCF4482D359867EC58' .
            '4149EBCFD76D8962BD30C67559A345E82BEE144CCAC0B0C2276BCD40F02CE77127D',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            '52752A26E36FB66DA6EF7C7D0559392A097E97C55908BAA1EF7330969D70C' .
            'E291E3820493AF44A28143BF5E34502EA3BFB2E04E4D95290999A53A1917ED67DB5',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            'F4F3A06CEFB3E82B38313095A6013C601CC3D2CB8B64CED60FA36086ED4536' .
            'F25E8DE2DFA9A52698452F323B860E17196F88575A9209AC7C580B9DA5DF7AFC64',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            'D55F0E84F651C3E0D2A90BD52C1C151A59AAA20B7DB2334C521C99BBB07029F7' .
            '481466B2DD4B69C757E99691493A2242A78B79A9997B1A8353589E382CA4C316',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            'B0E5BE4BECA4BB63C6487CD0CD59136FD33EC5E274E4518613C08955630AA13E0' .
            'D067C19207536EDBAD80A7E1CB5FB4C475D4F2CC271B8F4183FA02A2DDF390B',
            $hasher->hashData($data)
        );
        ...
        $this->assertEquals(
            '63F1D0B408287BD51C19D719838197BD25D6A452DA289B83D45EE2BB4E3100AA12' .
            'DA6B519838260A3FDD7D633CD69655C6FD09A9B97B12A13D734D817B6898D9',
            $hasher->hashData($data)
        );
    }
