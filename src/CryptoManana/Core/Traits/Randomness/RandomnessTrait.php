...
/**
 * Trait for forcing other traits or objects to implement basic randomness methods.
 */

namespace CryptoManana\Core\Traits\Randomness;

/**
 * Trait RandomnessTrait - Reusable forcing of the `AbstractRandomness` specification.
 *
 * @see \CryptoManana\Core\Abstractions\Randomness\AbstractRandomness The abstract specification.
 *
 * @package CryptoManana\Core\Traits\Randomness
 */
trait RandomnessTrait
{
    /**
