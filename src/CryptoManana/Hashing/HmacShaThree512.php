...
/**
 * The SHA-3 family HMAC-SHA-512 hashing algorithm class.
 */
...
/**
 * Class HmacShaThree512 - The SHA-3 family HMAC-SHA-512 hashing algorithm object.
 *
 * @package CryptoManana\Hashing
 */
class HmacShaThree512 extends KeyedHashAlgorithm
{
    /**
     * The internal name of the algorithm.
     */
    const ALGORITHM_NAME = 'sha3-512';
    ...
    public function hashData($data)
    {
        ...
        $digest = ($this->useNative) ?
            \CryptoManana\Compatibility\NativeHmacSha3::digest512($data, $this->key, $rawOutput)
            :
