...
/**
 * The SHA-3 family HKDF-SHA-512 hashing algorithm class.
 */
...
/**
 * Class HkdfShaThree512 - The SHA-3 family HKDF-SHA-512 hashing algorithm object.
 *
 * @package CryptoManana\Hashing
 */
class HkdfShaThree512 extends KeyDerivationAlgorithm
{
    /**
    ...
    public function hashData($data)
    {
        ...
        $digest = ($this->useNative) ?
            \CryptoManana\Compatibility\NativeHkdfSha3::digest512(
                $data,
                $this->outputLength,
