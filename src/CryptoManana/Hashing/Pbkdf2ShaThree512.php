...
/**
 * The SHA-3 family PBKDF2-SHA-512 hashing algorithm class.
 */
...
/**
 * Class Pbkdf2ShaThree512 - The SHA-3 family PBKDF2-SHA-512 hashing algorithm object.
 *
 * @package CryptoManana\Hashing
 */
class Pbkdf2ShaThree512 extends SlowDerivationAlgorithm
{
    /**
    ...
    public function hashData($data)
    {
        ...
        $digest = ($this->useNative) ?
            \CryptoManana\Compatibility\NativePbkdf2Sha3::digest512(
                $data,
                $this->derivationSalt,
